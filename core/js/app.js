define([
   'underscore',
	...
	function navStructure() {
		this.version = "1.7.0"; //*DO NOT MODIFY. Auto-generated by build*//
	...
	---------------------------------------------------------------------------------------*/		
		...
		this.moveFiles = function(){
			...
			$.post('../../editor.php', { action:"moveFiles", filename: filename, content: "" }, function(data){
				 // console.log( JSON.parse(data));
				//console.log(data); //doesnt like to be parsed apparently...
						}).fail(function() {
